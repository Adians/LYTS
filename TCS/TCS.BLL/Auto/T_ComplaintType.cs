...
namespace TCS.BLL
{
    public partial class T_ComplaintTypeService
    {

        /// <summary>
        /// 数据库操作对象
        /// </summary>
        private T_ComplaintTypeDAO _dao = new T_ComplaintTypeDAO();
