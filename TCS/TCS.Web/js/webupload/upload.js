(function ($) {
    // 当domReady的时候开始初始化
    $(function () {
        var $tousu =$('#tousupublishform'),
        //var $wrap = $('#uploader'),
        $wrap = $tousu.find('#uploader'),
        ...
        if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
            ...
            if (flashVersion) {
                (function (container) {
                    ...
                    var swf = '/js/webupload/expressInstall.swf';
                    // insert flash object
        ...
        function setState(val) {
            ...
            switch (state) {
                case 'pedding':
                    ...
                    var $uploadBtn = $tousu.find('.state-pedding');
                    $uploadBtn.css('display', 'none');
                    var submitBtn = $tousu.find('.submitform');
                ...
                case 'ready':
                    ...
                    var $uploadBtn = $tousu.find('.state-ready');
        ...
        uploader.on('uploadSuccess', function (file, response) {
            if (response.chunked) {
                $.post("/handler/MergeFiles.ashx", { guid: GUID, fileExt: response.f_ext },
                function (data) {
                    data = $.parseJSON(data);
                    if (data.hasError) {
                        alert('文件合并失败！');
