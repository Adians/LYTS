<%@ Page Title="" Language="C#" MasterPageFile="~/share/tousuAdmin.Master" AutoEventWireup="true" CodeBehind="icons.aspx.cs" Inherits="TCS.Web.admin.icons" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderAdminbar" runat="server">
    <li class="active"><span title="投诉分类图标" data-href="tousu-category.aspx">投诉分类图标</span><em></em></li>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderAdmin2" runat="server">
      <nav class="breadcrumb" style="padding-top: 0px;"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 投诉管理 <span class="c-gray en">&gt;</span> 图标库<a class="btn btn-success radius r mr-20" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
              ...
              <div class="col-lg-12 col-md-12 col-lg-offset-2">
                <div class="widget no-margin">
                  ...
                  <div class="widget-body">
                    <ul class="icons-container clearfix">
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderAdmin3" runat="server">
    <script>
        ...
        $("#menu-product li:eq(2) ").css("background-color", "rgba(171, 166, 166, 0.43)");
        $("#menu-product li:eq(2) a").css("color", "#06c");
    </script>
</asp:Content>
