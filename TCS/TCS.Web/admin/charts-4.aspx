<%@ Page Title="" Language="C#" MasterPageFile="~/share/tousuAdmin.Master" AutoEventWireup="true" CodeBehind="charts-4.aspx.cs" Inherits="TCS.Web.admin.charts_4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderAdminbar" runat="server">
    <li class="active"><span title="柱状图" data-href="charts-4.aspx">柱状图</span><em></em></li>
 </asp:Content>   
