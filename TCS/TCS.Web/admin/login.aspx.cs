        ...
        private void Login()
        {
            ...
            switch (res)
            {
                ...
                case LoginResult.登录成功:
                    ...
                    {
                        //处理记住我
                        //HttpCookie c1 = new HttpCookie("ayh");
                        //c1.Value = Username;
                        //HttpCookie c2 = new HttpCookie("ayhmm");
                        //c2.Value = user.u_password;
                        //Response.Cookies.Add(c1);
                        //Response.Cookies.Add(c2);
                        CookieHelper.Set("ayh", Username, DateTime.Now.AddDays(7));
                        CookieHelper.Set("ayhmm", user.u_password, DateTime.Now.AddDays(7));
                    }
