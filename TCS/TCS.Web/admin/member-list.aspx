<%@ Page Title="" Language="C#" MasterPageFile="~/share/tousuAdmin.Master" AutoEventWireup="true" CodeBehind="member-list.aspx.cs" Inherits="TCS.Web.admin.member_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderAdminbar" runat="server">
    <li class="active"><span title="用户列表" data-href="member-list.aspx">用户列表</span><em></em></li>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderAdmin2" runat="server">
    ...
    <div class="pd-20" >
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">
            ...
            {%><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加用户','member-add.aspx','800','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a><%} %></span> <span class="r">共有数据：<strong><%=totalcount %></strong> 条</span> </div>
        <div class="mt-20" >
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderAdmin3" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#menu-member li:eq(0) ").css("background-color", "rgba(171, 166, 166, 0.43)");
            $("#menu-member li:eq(0) a").css("color", "#06c");
            $('.table-sort').dataTable({
                "aaSorting": [[1, "desc"]],//默认第几个排序
                "bStateSave": true,//状态保存
                "iDisplayLength": 10,
                "aLengthMenu": [[10, 25, 50, -1], [10, 25, 50, "显示所有"]],
                "sAjaxSource": '../handler/userList.ashx',
                ...
                "aoColumns": [{
                    ...
                    "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                        ...
                        var str;
                        if (oData.STATUE == "已启用") {
                            str = "<a style=\"text-decoration:none\"  onClick=\"member_stop(this," + sData + ")\" href=\"javascript:;\" title=\"停用\"><i class=\"Hui-iconfont\">&#xe631;</i></a>";
                        } else {
                            str = "<a style=\"text-decoration:none\" onClick=\"member_start(this," + sData + ")\" href=\"javascript:;\" title=\"启用\"><i class=\"Hui-iconfont\">&#xe6e1;</i></a>";
                        }
                        $(nTd).html(str + "<a title=\"编辑\" href=\"javascript:;\" onClick=\"member_edit('编辑','/admin/member-add.aspx','" + sData + "','" + oData.LOGINNAME + "','" + oData.NICKNAME + "','" + oData.PHONE + "','" + oData.REALNAME + "','" + oData.EMAIL + "','" + oData.SEX + "','800','510')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a> <a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"change_password('修改密码','change-password.aspx','" + sData + "','" + oData.LOGINNAME + "','600','270')\" href=\"javascript:;\" title=\"修改密码\"><i class=\"Hui-iconfont\">&#xe63f;</i></a> <a title=\"删除\" href=\"javascript:;\" onClick=\"member_del(this,'" + sData + "')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>");
                        <%}else {%>
        ...
        /*密码-修改*/
        function change_password(title, url, id,name, w, h) {
            ...
            layer.open({
                ...
                success: function (layero, index) {
                    ...
                    var iframeWin = window[layero.find('iframe')[0]['name']]; //得到iframe页的窗口对象，执行iframe页的方法：iframeWin.method();
                    //console.log(body.html()) //得到iframe页的body内容
                    body.find('#epUserName').text(name);
                    body.find('#epUserId').val(id);
                }
            });
